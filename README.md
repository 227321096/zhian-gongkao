...
- 首页学习进度、连续天数、正确率、已刷题统计
- 今日任务勾选，进度环自动联动
- 刷题页支持题型筛选、答题反馈、解析、下一题
- 错题会自动进入复盘列表
- 收藏题、错题数、答题数会保存在本机
- 我的页展示错题复盘、收藏题和学习设置入口
- 支持添加到手机主屏幕和基础离线缓存
...
```text
https://227321096.github.io/zhian-gongkao/cuboid-sim.html
```

它展示为什么只用 3 种长度时，纸盒三条棱只能是 `1`、`1`、`√2`，因此体积为 `√2` 立方分米。
